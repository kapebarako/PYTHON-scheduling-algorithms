...
#functions
def header():
  print("ML-ACT7: Replacement Algorithm - LRU")
...
def turnsys():
  if requested[page] in alloc:
    pageIndex = alloc.index(requested[page])
    turns[pageIndex] = turns[pageIndex]+1
